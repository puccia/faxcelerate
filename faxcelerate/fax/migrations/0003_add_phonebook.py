...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PhonebookEntry'
        db.create_table('fax_phonebookentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fax.Sender'])),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('fax', ['PhonebookEntry'])


    def backwards(self, orm):
        
        # Deleting model 'PhonebookEntry'
        db.delete_table('fax_phonebookentry')
    ...
    models = {
        ...
        'fax.phonebookentry': {
            'Meta': {'object_name': 'PhonebookEntry'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
