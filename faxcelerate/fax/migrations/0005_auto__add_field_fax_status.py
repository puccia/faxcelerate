...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fax.status'
        db.add_column('fax_fax', 'status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fax.status'
        db.delete_column('fax_fax', 'status')
    ...
    models = {
        ...
        'fax.fax': {
            ...
            'device': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'expiry': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'in_folders': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['fax.Folder']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
        ...
        'fax.phonebookentry': {
            'Meta': {'ordering': "('subject',)", 'object_name': 'PhonebookEntry'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fax.Sender']"})
        },
        'fax.sender': {
            'Meta': {'ordering': "('label',)", 'object_name': 'Sender'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '80', 'unique': 'True'})
        },
        'fax.sendercid': {
